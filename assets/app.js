...
const materialFormTemplates = {
  ...
  input_data_umum: {
    ...
    fields: [
      { label: "Desa", name: "desa", type: "text", value: "Gudangharjo" },
      { label: "Kecamatan", name: "kecamatan", type: "text", value: "Paranggupito" },
      { label: "Kabupaten", name: "kabupaten", type: "text", value: "Wonogiri" },
      { label: "Provinsi", name: "provinsi", type: "text", value: "Jawa Tengah" },
      { label: "Tahun Anggaran", name: "tahun_anggaran", type: "text", value: "2026" },
      { label: "Nama Kepala Desa", name: "nama_kepala_desa", type: "text", placeholder: "Nama kepala desa" },
      { label: "Nama Sekretaris Desa", name: "nama_sekretaris_desa", type: "text", placeholder: "Nama sekretaris desa" },
      { label: "Nama Ketua Tim", name: "nama_ketua_tim", type: "text", placeholder: "Nama ketua tim" },
      { label: "No SK Tim Penyusun RPJMDes", name: "no_sk_tim_penyusun_rpjmdes", type: "text", placeholder: "Nomor SK" },
      { label: "Perdes RPJMDesa", name: "perdes_rpjmdesa", type: "text", placeholder: "Nomor Perdes" },
      { label: "Status Perdes RPJMDes", name: "status_perdes_rpjmdes", type: "select", options: ["RANCANGAN PERATURAN DESA", "PERATURAN DESA"], value: "RANCANGAN PERATURAN DESA" },
      { label: "Alamat Desa", name: "alamat_desa", type: "textarea", full: true, placeholder: "Alamat kantor desa" },
    ],
  },
  input_misi_desa: {
    key: "input_misi_desa",
